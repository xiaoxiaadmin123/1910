...
<center>
    ...
    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="{{url('/goods/store')}}" method="post" >
    @csrf   
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <textarea type="text" class="form-control" id="firstname" name="goods_desc" placeholder="请输入商品介绍"></textarea>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="firstname" name="goods_score" placeholder="请输入商品积分">
            </div>
        </div>
        <div class="form-group">
