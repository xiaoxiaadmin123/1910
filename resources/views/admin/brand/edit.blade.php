...
<center>
    ...
    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="{{url('/brand/update/'.$brand->brand_id)}}" method="post">
    @csrf   
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="lastname" name="brand_url"  placeholder="请输入品牌网址" value="{{$brand->brand_url}}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <textarea type="text" class="form-control" id="lastname" name="brand_desc"  placeholder="请输入品牌描述">{{$brand->brand_desc}}</textarea>
            </div>
        </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <input type="submit" class="btn btn-default" value="点我编辑品牌">
            </div>
        </div>
    </form>
</center>
